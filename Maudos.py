...
def usage():
    print "\033[1;32m#############################################################"
    print "#------------------------[\033[1;91maulana-DDOS\033[1;32m]---------------------#"
    print "#-------------------------------------------------------#"
    print "#   \033[1;91mCommand: " "python2 maudos.py " "<ip> <port> <packet> \033[1;32m   #"
    print "# ==> privasi, situs Indonesia, created by Maulana <== #"
    print "# ==> Indonesia website ddoser, v.1 <== #"
    print "# ======================================================#"
    print "#                                                       #"
    ...
    print "#                   ##  \033[1;91m##  \033[1;32m###   \033[1;91m##  \033[1;32m######            #"
    print "#               \033[1;91m<--[Indonesia Security dos]-->         \033[1;32m#"
    print "#########################################################"
    print "                        @@@@@@@@@@"
    print "                       @@@@@@@@@@@@"
    print "                     @@@@@@@@@@@@@@@@"
